...
class MyFrame(Frame):
    ...
    def login_button_click(self):
        ...
        #check validity using login_validity
        if (self.bank.login_validity(u, p)):
            #returns account object
            self.account = self.bank.load_account(u, p)
    ...
    def summary_interface(self):
        ...
        # create and place options and next buttons
    ...
    def summary(self):
        ...
        self.clear_frame()
        # creates lables for the account summary
        ...
        # organizes the lables in the window
    ...
    def withdraw_interface(self):
        self.clear_frame()
        # amount to withdraw label and entry
